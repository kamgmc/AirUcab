...
create table Empleado(
	...
	em_usuario varchar(30) unique not null,
	...
	em_supervisa boolean not null,
	em_gerencia boolean not null,
	em_nota text,
...
create table Modelo_avion(
	...
	am_tiempo_estimado integer not null,
	...
	constraint Check_am_tiempo_estimado check(am_tiempo_estimado > 0),
...
create table Tipo_pago(
	pt_id serial,
	pt_numero numeric(16,0) not null,
...
create table Avion(
	...
	a_precio numeric(12,2) not null,
