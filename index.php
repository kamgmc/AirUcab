							...
							<div class="card-columns">
                                ...
                                $pieza = pg_fetch_object($rs2);?>
									<div class="card">
										<div class="card-body">
											...
											<form id="form-produccion-anual">
												<div class="col-sm-12 select">
													...
													while( $tiempo = pg_fetch_object($rs) ){?>
															<option <?php if($tiempo->fecha == date('Y')) print 'selected';?> value="
											...
											<p id="produccion-anual-target" class="card-text"> Aviones:
												<?php print $avion->cantidad.'<br/>';?> Piezas:
													<?php print $pieza->cantidad; ?>
											</p>
										</div>
									</div>
									...
									<div class="card">
										...
										<div class="card-body">
											...
											<p id="produccion-mensual-target" class="card-text"> Aviones:
												<?php print number_format($avion->cantidad, 2, ',', '.'); ?>
													<br> Piezas:
													<?php print number_format($pieza->cantidad, 2, ',', '.'); ?>
											</p>
										</div>
									</div>
									<?php } if( in_array("cl_r", $permiso) ){?>
										...
										while( $tiempo = pg_fetch_object($rs2) ){?>
											...
											<div id="mejores-clientes-target">
												<?php while( $cliente = pg_fetch_object($rs) ){?>
													<p class="card-text"> <strong><?php print $cliente->nombre; ?></strong>
														<?php print $cliente->cantidad; ?> ventas. </p>
													<?php }?>
											</div>
										</div>
									</div>
										...
										<div class="card-body">
											...
											<div id="modelos-producidos-target">
												<?php while( $modelo = pg_fetch_object($rs) ){?>
													<p class="card-text"> <strong><?php print $modelo->nombre;?></strong>
														<?php print number_format($modelo->cantidad, 2, ',', '.'); ?> ventas.
													</p>
												<?php }?>
											</div>
										</div>
									...
									<div class="card">
										...
										<div class="card-body">
											...
											<p class="card-text"> <strong><?php print $modelo->nombre; ?></strong>
												<?php print $modelo->cantidad; ?> Unds. </p>
										</div>
									</div>
									...
									<div class="card">
										...
										<div class="card-body">
											...
											<p class="card-text"> <strong><?php print $equipo->zona; ?></strong> de la sede
												<?php print $equipo->sede; ?>
											</p>
										</div>
									</div>
										...
										<div class="card-body">
											...
											<form>
												...
												<div class="col-sm-12 select">
													<select id="month-inventario-mensual" name="submodelo" class="form-control">
														<?php 
														for($x=1; $x < 13; $x++){?>
															<option <?php if($x==date('n')) print 'selected';?> value="
																<?php print $x;?>">
																	<?php print $meses[$x];?>
															</option>
															<?php }?>
											...
											<div id="inventario-mensual-target">
												<?php while( $material = pg_fetch_object($rs) ){?>
													<p class="card-text"> <strong><?php print $material->nombre;?></strong>
														<?php print number_format($material->cantidad, 0, ',', '.'); ?> unds </p>
													<?php }?>
											</div>
										</div>
									</div>
									...
									<div class="card">
										...
										<div class="card-body">
											...
											<p class="card-text"> <strong><?php print $material->material; ?></strong>
												<?php print $material->cantidad; ?> unds </p>
										</div>
									</div>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<p class="card-text"> <strong><?php print $ala->nombre; ?></strong> se utiliza en
											<?php print $ala->cantidad;?> aviones </p>
									</div>
								</div>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<p class="card-text"> <strong><?php print $pieza->rechazados;?></strong> unds </p>
									</div>
								</div>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<?php while( $sede = pg_fetch_object($rs) ){?>
											<p class="card-text"> <strong><?php print $sede->nombre;?></strong>
												<?php print $sede->promedio;?> en promedio. </p>
											<?php }?>
									</div>
								</div>
								<?php }}?>
