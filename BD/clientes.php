		...
		<div class="page-content d-flex align-items-stretch">
			...
			<nav class="side-navbar">
				...
				<ul class="list-unstyled">
					<li> <a href="empleados.html"><i class="icon-man-people-streamline-user"></i>Empleados</a></li>
					<li class="active">
						<a href="clientes.html"> <i class="fa fa-address-book-o" aria-hidden="true"></i>Clientes</a>
					</li>
					<li>
						<a href="proveedores.html"> <i class="fa fa-truck" aria-hidden="true"></i>Proveedores</a>
					</li>
					<li>
						<a href="ventas.html"> <i class="fa fa-plane" aria-hidden="true"></i>Ventas </a>
					</li>
					<li>
						<a href="forms.html"> <i class="fa fa-cog" aria-hidden="true"></i>Compras </a>
					</li>
				</ul>
			</nav>
								...
								<div class="card">
									...
									<div class="card-body">
										<table class="table table-striped table-sm table-hover">
											...
											<tbody>
												<?php 	
							$qry = "SELECT cl_id, cl_tipo_rif, cl_rif, cl_nombre, SUM(a_precio) as monto, cl_fecha_inicio as fecha, COUNT(a_id) as ventas, lu_nombre FROM Cliente left join Factura_venta ON fv_cliente=cl_id LEFT JOIN Avion ON a_factura_venta=fv_id LEFT JOIN Lugar ON lu_id=cl_direccion GROUP BY cl_id, cl_tipo_rif, cl_rif, cl_nombre,cl_fecha_inicio,lu_nombre ORDER BY cl_id";
							...
							while( $cliente = pg_fetch_object($rs) ){?>
													<tr>
														...
														<td class="text-center">
															<a href="" data-toggle="modal" data-target="#ModalCliente<?php print $cliente->cl_id;?>"> <i class="fa fa-file-text-o" aria-hidden="true"></i> </a>
													...
													<div class="row">
														...
														<div class="card-body col-lg-6">
															<div class="row">
																<div class="col-lg-4">
																	<h3>Nombre</h3> </div>
																<div class="col-lg-8"> <?php print $cliente->cl_nombre;?> </div>
															</div>
															<div class="row">
																<div class="col-lg-4">
																	<h3>CI/RIF</h3> </div>
																<div class="col-lg-8"> <?php print $cliente->cl_tipo_rif."-".$cliente->cl_rif;?> </div>
															</div>
															<div class="row">
																<div class="col-lg-4">
																	<h3>Direccion</h3> </div>
																<div class="col-lg-8"> <?php print $cliente->parroquia.", ".$cliente->municipio.", ".$cliente->estado;?> </div>
															</div>
															<div class="row">
																<div class="col-lg-4">
																	<h3>Contacto</h3> 
														...
														<div class=" card-body col-lg-6">
															<div class="row">
																...
																<div class="col-lg-8"> <?php print number_format($cliente->monto, 2, ',', '.')." Bs";?> </div>
															</div>
															<div class="row">
																<div class="col-lg-4">
															...
															<div class="row">
																<div class="col-lg-4">
																	<h3>Nota</h3> </div>
																<div class="col-lg-8"> <?php print $cliente->cl_nota;?>  </div>
															</div>
														</div>
													</div>
												</div>
												...
												<?php 	$qry = "SELECT COUNT(fv_id) total FROM Factura_venta where fv_cliente=".$cliente->cl_id;
													...
													<table class="table table-striped table-sm table-hover">
														...
														<tbody>
															...
															<tr>
																<td><?php print $venta->id;?></td>
																<td><?php $date = new DateTime($venta->fecha); print $date->format('d-m-Y');?></td>
																<td><?php print $venta->avion." - ".$venta->id_avion;?></td>
																<td><span class="badge badge-success"><?php print $venta->status;?></span></td>
																<td><div class="col-lg-8"> <?php print number_format($venta->precio, 2, ',', '.')." Bs";?> </div></td>
																<td class="text-center">
																	<a href="" data-toggle="modal" data-target="#myModalEmpleado"> <i class="fa fa-file-text-o" aria-hidden="true"></i> </a>
														...
														<div class="card-body col-lg-6">
															...
															<div class="form-group row">
																...
																<div class="col-sm-9 select">
																	...
																	while( $estado = pg_fetch_object($answer) ){?>
																		<option value="<?php print $estado->id;?>" <?php if($estado->id==$cliente->id_estado) print "selected";?>><?php print $estado->nombre;?></option>
																	<?php }?>
																	</select>
																</div>
															</div>
															<div class="form-group row">
																...
																<div class="col-sm-9 select">
																	...
																	while( $municipio = pg_fetch_object($answer) ){?>
																		<option value="<?php print $municipio->id;?>" <?php if($municipio->id==$cliente->id_municipio) print "selected";?>><?php print $municipio->nombre;?></option>
																	<?php }?>
																	</select>
																</div>
															</div>
															<div class="form-group row">
																...
																<div class="col-sm-9 select">
																	...
																	while( $parroquia = pg_fetch_object($answer) ){?>
																		<option value="<?php print $parroquia->id;?>" <?php if($parroquia->id==$cliente->id_parroquia) print "selected";?>><?php print $parroquia->nombre;?></option>
																	<?php }?>
																	</select>
																</div>
															</div>
															...
															<div class="form-group row">
																<label class="col-sm-3 form-control-label">
																	<h3>CI/RIF</h3> </label>
																<div class="col-sm-9">
																	<input type="text" value="<?php print $cliente->cl_rif;?>" class="form-control"> 
																</div>
															</div>
															<div class="form-group row">
																<label class="col-sm-3 form-control-label">
																...
																<div class="col-sm-9">
																	<input type="text" value="<?php print $cliente->web;?>" class="form-control"> 
																</div>
															</div>
														</div>
														<div class=" card-body col-lg-6">
															<div class="form-group row">
																...
																<div class="col-sm-9">
																	...
																	<div class="input-group">
																		...
																		<input type="text" value="<?php print $contacto->valor;?>" class="form-control"> 
																	</div>
																	<br>
																	<?php }?>
																</div>
														...
														<div class="card-body col-lg-6">
															...
															<div class="form-group row">
																...
																<div class="col-sm-9 select">
																	...
																	$answer = pg_query( $conexion, $qry );
																	while( $estado = pg_fetch_object($answer) ){?>
																		<option value="<?php print $estado->id;?>"><?php print $estado->nombre;?></option>
																	<?php }?>
																	</select>
																</div>
															</div>
															<div class="form-group row">
																<label class="col-sm-3 form-control-label">
																	<h3>Municipio</h3> </label>
																<div class="col-sm-9 select">
																	<select id="list-municipios" disabled name="account" class="form-control">
																	</select>
																</div>
															</div>
															<div class="form-group row">
																<label class="col-sm-3 form-control-label">
																	<h3>Parroquia</h3> </label>
																<div class="col-sm-9 select">
																	<select id="list-parroquias" disabled name="account" class="form-control">
																	</select>
																</div>
															</div>
															<div class="form-group row">
	...
	<script>
		$( document ).ready(function() {
    		$("#list-estados").change(function() {
				...
				$.ajax({type: "POST",dataType: "html",url:"getter.php?get=municipios&id="+iden,success: function(data){$("#list-municipios").html(data);}});
			});
			$( "#list-municipios" ).change(function() {
				var iden = $( "#list-municipios option:selected" ).val();
				$("#list-parroquias").removeAttr('disabled');
				$.ajax({type: "POST",dataType: "html",url:"getter.php?get=parroquias&id="+iden,success: function(data){$("#list-parroquias").html(data);}});
			});
			$("#list-estados-up").change(function() {
				var municipio = $(this).closest(".form-group").siblings().children("#list-municipios-up");
				var iden = $( "#list-estados-up option:selected" ).val();
				$.ajax({type: "POST",dataType: "html",url:"getter.php?get=municipios&id="+iden,success: function(data){municipio.html(data);}});
			});
			$( "#list-municipios-up" ).change(function() {
				var iden = $( "#list-municipios-up option:selected" ).val();
				$.ajax({type: "POST",dataType: "html",url:"getter.php?get=parroquias&id="+iden,success: function(data){$("#list-parroquias-up").html(data);}});
			});
		});
	</script>
</body>
