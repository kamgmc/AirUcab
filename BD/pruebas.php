						...
						<section id="content0" class="sectiontab">
							...
							<div class="col-md-12">
								<div class="card">
                                    ...
                                    <?php }?>
									<?php $qry = "select pr_id id, pr_nombre nombre, em_nombre||' '||em_apellido empleado, st_nombre status 
													From prueba pr, Empleado, Status 
													Where pr_empleado=em_id 
													AND st_id=(Select Max(sp_status) From Status_prueba Where sp_prueba=pr.pr_id) 
													AND pr_tipo='Prueba'
													Order By nombre";
											...
											<tbody>
												...
												<tr>                                                    
													...
													<td class="text-center">
														...
														<a href="prueba-crud.php?delete=<?php print $prueba->id;?>"> 
